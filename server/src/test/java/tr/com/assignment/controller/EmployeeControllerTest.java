package tr.com.assignment.controller;
...
import tr.com.assignment.employee.EmployeeController;
import tr.com.assignment.employee.EmployeeService;
...
public class EmployeeControllerTest {
    ...
    public void test_get_all_success() throws Exception {
        List<Employee> employees = Arrays.asList(
        		new Employee(1, "yasar", "kumru", 12000, 1),
        		new Employee(2, "ilker", "catak", 10000, 1));
        ...
        mockMvc.perform(get("/employees"))
                ...
                .andExpect(jsonPath("$[0].name", is("yasar")))
                .andExpect(jsonPath("$[1].id", is(2)))
                .andExpect(jsonPath("$[1].name", is("ilker")));
    ...
    public void test_get_by_id_success() throws Exception {
    	Employee employee = new Employee(1, "yasar", "kumru", 12000, 1);
        ...
        mockMvc.perform(get("/employees/{id}", 1))
                ...
                .andExpect(jsonPath("$.name", is("yasar")));
